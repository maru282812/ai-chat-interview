 ...
 *
 * 確認項目:
 * 1. buildInitialTemplatesForPreset('standard') が21キー全てを enabled+template 付きで返す
...
// ---------------------------------------------------------------------------
test("Phase9: buildInitialTemplatesForPreset('standard') が全21キーを実体化する", () => {
...
test("Phase9: standard 生成の定義率は 21/21（全てカスタム実体）", () => {
...
test("Phase9: null templates_json は全キー base 扱い（defined=21, custom=0）", () => {
